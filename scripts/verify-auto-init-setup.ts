...
async function verifySetup() {
  ...
  checkFile('VERCEL_VPS_SPLIT_DEPLOYMENT.md', 'Split deployment guide')
  checkFile('DEPLOYMENT_QUICKSTART.md', 'Quick start guide')
  checkFile('WORKER_AUTO_INITIALIZATION.md', 'Runtime behaviour note')
  checkFileMissing('vercel.json', 'Retired Vercel worker cron')

  console.log('\nDocumentation alignment:')
  checkFileContains('DEPLOYMENT_QUICKSTART.md', 'Vercel', 'Quick start references Vercel')
  checkFileContains('DEPLOYMENT_QUICKSTART.md', 'VPS', 'Quick start references VPS')
  checkFileContains('VERCEL_VPS_SPLIT_DEPLOYMENT.md', 'GAIALOG_WORKER_PROCESS=0', 'Split guide documents read-only Vercel')
  checkFileContains('VERCEL_VPS_SPLIT_DEPLOYMENT.md', 'GAIALOG_WORKER_PROCESS=1', 'Split guide documents worker VPS')
  ...
  if (passed === total) {
    ...
    console.log('  4. Read VERCEL_VPS_SPLIT_DEPLOYMENT.md before rollout')
    process.exit(0)
  } else {
