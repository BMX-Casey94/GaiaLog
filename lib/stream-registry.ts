...
export const PROVIDER_DESCRIPTORS = {
  ...
  open_meteo: {
    ...
    sourceAliases: ['Open-Meteo', 'open-meteo.com'],
  },
  noaa_alerts: {
    id: 'noaa_alerts',
    displayName: 'NOAA NWS Alerts',
    primaryFamily: 'natural_events',
    kind: 'poll',
    queueLane: 'throughput',
    throughputClass: 'high',
    keyRequired: false,
    blockchainFriendly: true,
    sourceAliases: ['NOAA NWS Alerts', 'NWS Alerts', 'api.weather.gov'],
  },
  gdacs: {
    id: 'gdacs',
    displayName: 'GDACS',
    ...
    blockchainFriendly: true,
    attributionRequired: true,
    attributionText: 'Data: Global Disaster Alert and Coordination System (gdacs.org).',
    sourceAliases: ['GDACS', 'Global Disaster Alert and Coordination System'],
  },
  reliefweb: {
    id: 'reliefweb',
    ...
    blockchainFriendly: true,
    attributionRequired: true,
    attributionText: 'Data: ReliefWeb (UN OCHA) — reliefweb.int.',
    sourceAliases: ['ReliefWeb', 'UN OCHA ReliefWeb'],
  },
  met_no: {
    id: 'met_no',
    ...
    blockchainFriendly: true,
    attributionRequired: true,
    attributionText: 'Weather forecast by MET Norway (CC BY 4.0).',
    sourceAliases: ['MET Norway', 'met.no', 'Norwegian Meteorological Institute'],
  },
  hubeau_france: {
    id: 'hubeau_france',
    displayName: "Hub'Eau France",
    primaryFamily: 'hydrology',
    kind: 'bulk',
    queueLane: 'throughput',
    throughputClass: 'very_high',
    ...
    blockchainFriendly: true,
    attributionRequired: true,
    attributionText: "Data: Hub'Eau / Eau France (Etalab Open Licence 2.0).",
    sourceAliases: ["Hub'Eau France", 'Hub Eau France', 'hubeau.eaufrance.fr'],
  },
...
export const DATASET_DESCRIPTORS = {
  ...
  noaa_swpc_aurora: {
    ...
    providerId: 'noaa_space_weather',
    family: 'space_weather',
    displayName: 'NOAA SWPC Aurora & Indices',
    sourceLabel: 'NOAA Space Weather',
    kind: 'poll',
    queueLane: 'coverage',
    defaultPriority: 'normal',
    ...
    keyRequired: false,
    blockchainFriendly: true,
    metricPreviewKeys: ['kp_index', 'aurora_power_gw', 'f10_7_flux', 'r_scale', 's_scale', 'g_scale'],
  },
  open_meteo_forecast: {
    id: 'open_meteo_forecast',
    providerId: 'open_meteo',
    family: 'advanced_metrics',
    displayName: 'Open-Meteo Current Conditions',
    ...
    keyRequired: false,
    blockchainFriendly: true,
    metricPreviewKeys: ['temperature_c', 'humidity_pct', 'pressure_mb', 'wind_kph', 'precipitation_mm', 'cloud_cover_pct'],
  },
  noaa_alerts_active: {
    ...
    keyRequired: false,
    blockchainFriendly: true,
    metricPreviewKeys: ['event_type', 'severity', 'urgency', 'certainty', 'area_desc'],
  },
  gdacs_events: {
    id: 'gdacs_events',
    providerId: 'gdacs',
    family: 'natural_events',
    displayName: 'GDACS Disaster Events',
    sourceLabel: 'GDACS',
    kind: 'poll',
    queueLane: 'throughput',
    defaultPriority: 'high',
    ...
    keyRequired: false,
    blockchainFriendly: true,
    metricPreviewKeys: ['event_type', 'alert_level', 'severity', 'population_affected'],
  },
  reliefweb_disasters: {
    id: 'reliefweb_disasters',
    providerId: 'reliefweb',
    family: 'natural_events',
    displayName: 'ReliefWeb Disasters',
    ...
    keyRequired: false,
    blockchainFriendly: true,
    metricPreviewKeys: ['event_type', 'status', 'country'],
  },
  met_no_locationforecast: {
    id: 'met_no_locationforecast',
    providerId: 'met_no',
    family: 'advanced_metrics',
    displayName: 'MET Norway Location Forecast',
    ...
    keyRequired: false,
    blockchainFriendly: true,
    metricPreviewKeys: ['temperature_c', 'humidity_pct', 'pressure_mb', 'wind_kph', 'cloud_cover_pct'],
  },
  hubeau_france_hydrometry: {
    id: 'hubeau_france_hydrometry',
    providerId: 'hubeau_france',
    family: 'hydrology',
    displayName: "Hub'Eau France River Observations",
    sourceLabel: "Hub'Eau France",
    kind: 'bulk',
    queueLane: 'throughput',
    defaultPriority: 'normal',
    defaultIntervalMs: 15 * 60 * 1000,
    ...
    keyRequired: false,
    blockchainFriendly: true,
    metricPreviewKeys: ['river_level_m', 'discharge_cfs', 'station_name', 'parameter_name'],
  },
